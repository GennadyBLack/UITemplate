...
function useRender(render) {
  const vm = (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.getCurrentInstance)();
  if (!vm) {
    throw new Error({
      message: "Нельзя меен"
    });
...
/* harmony default export */ var Modal = ((0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.defineComponent)({
  ...
  setup(props, {
    ...
    useRender(() => (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.createVNode)(external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.Fragment, null, [(0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.createVNode)("div", {
      ...
      "onClick": open,
      "onFocus": open
    }, [slots?.default?.()]), (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.createVNode)((0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.resolveComponent)("Teleport"), {
      "to": props.placement,
      "disabled": !props.teleport
    }, {
      default: () => [(0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.createVNode)((0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.resolveComponent)("Transition"), {
        "name": props?.animation
      }, {
        default: () => [isOpen.value && (0,external_commonjs_vue_commonjs2_vue_root_Vue_namespaceObject.createVNode)("div", {
